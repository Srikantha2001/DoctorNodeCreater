...
infoln "Joining docorg peer to the channel..."

####
# ADDITION 1
####
joinChannel "docorg" 0
joinChannel "docorg" 1
joinChannel "docorg" 2
joinChannel "docorg" 3

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for docorg..."
setAnchorPeer "docorg" 
